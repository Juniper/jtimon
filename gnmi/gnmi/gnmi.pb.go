...
var file_proto_gnmi_gnmi_proto_rawDesc = []byte{
	...
	0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6f, 0x70, 0x65, 0x6e, 0x63, 0x6f, 0x6e, 0x66, 0x69,
	0x67, 0x2f, 0x67, 0x6e, 0x6d, 0x69, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x67, 0x6e, 0x6d,
	0x69, 0xca, 0x3e, 0x05, 0x30, 0x2e, 0x38, 0x2e, 0x30, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_proto_gnmi_gnmi_proto_depIdxs = []int32{
	...
	30, // 32: gnmi.SetRequest.extension:type_name -> gnmi_ext.Extension
	8,  // 33: gnmi.SetResponse.prefix:type_name -> gnmi.Path
	22, // 34: gnmi.SetResponse.response:type_name -> gnmi.UpdateResult
	11, // 35: gnmi.SetResponse.message:type_name -> gnmi.Error
	30, // 36: gnmi.SetResponse.extension:type_name -> gnmi_ext.Extension
	8,  // 37: gnmi.UpdateResult.path:type_name -> gnmi.Path
	11, // 38: gnmi.UpdateResult.message:type_name -> gnmi.Error
	3,  // 39: gnmi.UpdateResult.op:type_name -> gnmi.UpdateResult.Operation
	8,  // 40: gnmi.GetRequest.prefix:type_name -> gnmi.Path
	8,  // 41: gnmi.GetRequest.path:type_name -> gnmi.Path
	4,  // 42: gnmi.GetRequest.type:type_name -> gnmi.GetRequest.DataType
	0,  // 43: gnmi.GetRequest.encoding:type_name -> gnmi.Encoding
	27, // 44: gnmi.GetRequest.use_models:type_name -> gnmi.ModelData
	30, // 45: gnmi.GetRequest.extension:type_name -> gnmi_ext.Extension
	5,  // 46: gnmi.GetResponse.notification:type_name -> gnmi.Notification
	11, // 47: gnmi.GetResponse.error:type_name -> gnmi.Error
	30, // 48: gnmi.GetResponse.extension:type_name -> gnmi_ext.Extension
	30, // 49: gnmi.CapabilityRequest.extension:type_name -> gnmi_ext.Extension
	27, // 50: gnmi.CapabilityResponse.supported_models:type_name -> gnmi.ModelData
	0,  // 51: gnmi.CapabilityResponse.supported_encodings:type_name -> gnmi.Encoding
	30, // 52: gnmi.CapabilityResponse.extension:type_name -> gnmi_ext.Extension
	31, // 53: gnmi.gnmi_service:extendee -> google.protobuf.FileOptions
	25, // 54: gnmi.gNMI.Capabilities:input_type -> gnmi.CapabilityRequest
	23, // 55: gnmi.gNMI.Get:input_type -> gnmi.GetRequest
	20, // 56: gnmi.gNMI.Set:input_type -> gnmi.SetRequest
	14, // 57: gnmi.gNMI.Subscribe:input_type -> gnmi.SubscribeRequest
	26, // 58: gnmi.gNMI.Capabilities:output_type -> gnmi.CapabilityResponse
	24, // 59: gnmi.gNMI.Get:output_type -> gnmi.GetResponse
	21, // 60: gnmi.gNMI.Set:output_type -> gnmi.SetResponse
	16, // 61: gnmi.gNMI.Subscribe:output_type -> gnmi.SubscribeResponse
